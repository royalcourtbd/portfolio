...
import 'package:portfolio/core/config/app_theme_color.dart';
import 'package:portfolio/core/external_libs/flutter_toast/toast_utility.dart';
import 'package:portfolio/core/external_libs/throttle_service.dart';
import 'package:portfolio/core/static/constants.dart';
import 'package:portfolio/core/utility/logger_utility.dart';
import 'package:portfolio/core/utility/number_utility.dart';
...
/// ফাইল পাথ দিয়ে ফাইল আছে কিনা চেক করে
...
/// ফাইল কনটেন্ট আইসোলেটে লেখার ফাংশন
Future<void> writeFileAsBytesInIsolate(File file, List<int> bytes) async {
  await catchFutureOrVoid(() async {
    await compute((Map<String, dynamic> args) {
      final file = File(args['path'] as String);
      final bytes = args['bytes'] as List<int>;
      file.writeAsBytesSync(bytes);
      return true;
    }, {'path': file.path, 'bytes': bytes});
  });
}
