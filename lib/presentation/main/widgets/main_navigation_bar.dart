...
import 'package:portfolio/core/static/svg_path.dart';
import 'package:portfolio/core/utility/utility.dart';
import 'package:portfolio/presentation/main/widgets/nav_destination_item.dart';
      ...
      child: NavigationBar(
        ...
        destinations: [
          ...
          NavDestinationItem(
            index: 2,
            selectedIndex: selectedIndex,
            outlineIcon: SvgPath.icBookmarkOutline,
            fillIcon: SvgPath.icBookmarkFill,
            label: 'Bookmarks',
          ),
